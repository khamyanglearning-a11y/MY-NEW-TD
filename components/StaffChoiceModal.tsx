    ...
    <div className="fixed inset-0 z-[80] flex items-center justify-center p-4 bg-black/60 backdrop-blur-md animate-in fade-in duration-300">
      <div className="bg-white rounded-[3rem] w-full max-w-md shadow-2xl p-8 transform transition-all animate-in zoom-in duration-300">
        <div className="flex justify-between items-center mb-8">
          ...
          <button onClick={onClose} className="p-3 bg-white hover:bg-white rounded-full transition-colors border border-gray-100 shadow-sm">
        ...
        <div className="mt-8 pt-6 border-t border-gray-100 flex flex-col items-center">
          ...
          <button 
            onClick={onClose}
            className="px-6 py-2 bg-white text-gray-400 hover:text-gray-900 font-bold transition-colors border border-gray-100 rounded-xl shadow-sm"
          >
            Back to Welcome
          </button>
        </div>
